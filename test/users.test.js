...
describe('User route test', function() {
  ...
  // it('Should fail to create a user that already exists', function() {
  //   const username = 'hellomoto';
  //   const password = 'stevejobsismyhero';
  ...
  //       console.log('_RES BODY', _res.body.username);
  ...
  //         .request(app)
  //         .post('/api/users')
  //         .send({ username: 'hellomoto', password: 'stevejobsismyhero' })
  //         .then(response => {
  //           console.log('RESPONSE BODY', response.body.username);
  //           // expect(response).to.have.status(400);
  //           // expect(response.body).to.have.keys('status', 'message');
  //           // expect(response.body.message).to.be('The username already exists');

  //           return Users.findOne({ username: response.username });
  //         })
  //         .then(user => {
  //           console.log(user);
  //         });
